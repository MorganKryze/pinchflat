...
and the NFO options all sit in Settings, and the two queue switches sit on the status page. The orphaned-job rescue window lives in `ORPHANED_JOB_RESCUE_MINUTES`, because Oban reads
